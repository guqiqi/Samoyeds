...
class MLP(nn.Module):
    def __init__(
        ...
        self.w1 = nn.Linear(in_features=self.ffn_dim, out_features=self.hidden_dim)
        self.w2 = nn.Linear(in_features=self.hidden_dim, out_features=self.ffn_dim)
        self.w3 = nn.Linear(in_features=self.ffn_dim, out_features=self.hidden_dim)
...
class MoEBlock(nn.Module):
    ...
    def __init__(
        ...
        # self.gate = ReplicatedLinear(self.ffn_dim,
        #                              self.num_experts,
        #                              bias=False,
        #                              params_dtype=torch.bfloat16,
        #                              linear_method=None)

        self.experts = nn.ModuleList([MLP(self.ffn_dim, self.hidden_dim) for _ in range(self.num_experts)])
